...
class SubAreaPolicy
{
    ...
    {
        return $user->can('view_any_sub::area');
    }
    ...
    {
        return $user->can('create_sub::area');
    }
    ...
    {
        return $user->can('update_sub::area');
    }
    ...
    {
        return $user->can('delete_sub::area');
    }
    ...
    {
        return $user->can('delete_any_sub::area');
    }
     ...
     */
    public function replicate(User $user, SubArea $subArea): bool
    {
