...
//                    $record->visitorCards()->count() > 0),
    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Infolists\Components\Card::make(__('ui.profile'))
                    ->icon('heroicon-o-user-circle')
                    ->description(__('ui.user_profile_information'))
                    ->columns(3)
                    ->compact()
                    ->schema([
                        TextEntry::make('name')
                ...
                Infolists\Components\Card::make(__('ui.account_information'))
                    ->icon('heroicon-o-shield-check')
                    ->description(__('ui.user_account_status_details'))
                    ->columns(3)
                    ->compact()
                    ->schema([
                        TextEntry::make('roles.name')
                            ...
                            ->badge()
                            ->separator(',')
                            ->placeholder(__('ui.no_roles_assigned'))
                            ->icon('heroicon-o-shield-exclamation'),
                    ]),

                Infolists\Components\Card::make(__('ui.activity'))
                    ->icon('heroicon-o-clock')
                    ->description(__('ui.user_activity_timestamps'))
                    ->columns(4)
                    ->compact()
                    ->schema([
