...
# --- PHP repo (sury.org - Launchpad PPA yerine) ---
...
RUN pecl channel-update pecl.php.net && \
    ...
    echo "extension=igbinary.so" > /etc/php/8.4/mods-available/igbinary.ini && \
    ...
    phpenmod igbinary redis ssh2 sqlsrv pdo_sqlsrv
