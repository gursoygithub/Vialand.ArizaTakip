...
RUN apt-get update && \
    apt-get install -y software-properties-common curl wget gnupg ca-certificates apt-transport-https unzip git lsb-release sudo nano supervisor nginx
...
# --- ODBC ve SQL Server araçları ---
RUN ACCEPT_EULA=Y apt-get install -y unixodbc unixodbc-dev msodbcsql18 mssql-tools18

# --- PHP 8.4 ve gerekli eklentiler ---
RUN apt-get install -y \
    php8.4 php8.4-cli php8.4-common php8.4-fpm php8.4-mysql php8.4-zip \
    php8.4-gd php8.4-mbstring php8.4-curl php8.4-xml php8.4-bcmath php8.4-pdo \
    php8.4-bz2 php8.4-dev php8.4-igbinary php8.4-intl php8.4-opcache php8.4-readline \
    php8.4-ldap php8.4-redis php8.4-pgsql php8.4-ssh2 php8.4-soap

# --- SQL Server PHP eklentileri ---
