                ...
                <tr>
                    <td class="content-padding" style="padding: 30px;">
                        ...
                        <div style="margin-bottom: 30px; border: 1px solid #dee2e6; border-radius: 6px;">
                            <h3 style="margin: 0; padding: 15px; background-color: #f8f9fa; color: #333333; font-size: 18px; border-bottom: 1px solid #dee2e6;">
                                {{__('ui.task_details')}}
                            </h3>
                            <div style="padding: 15px;">
                                <p style="margin: 5px 0;">
                                    <strong style="display: inline-block; width: 150px; color: #555;">{{ __('ui.task_type') }}:</strong>
                                    <span style="font-weight: bold; padding: 3px 10px; border-radius: 4px; background-color: #d1ecf1; color: #0c5460; font-size: 14px;">
                                        {{ $task->type_id->getLabel() }}
                                    </span>
                                </p>
                                <p style="margin: 5px 0;">
                                    <strong style="display: inline-block; width: 150px; color: #555;">{{ __('ui.task_unit') }}:</strong>
                                    <span style="font-weight: bold;">{{ $task->unit->name }}</span>
                                </p>
                                <p style="margin: 5px 0;">
                                ...
                                <p style="margin: 15px 0 5px 0;">
                                    ...
                                    <span style="display: block; padding: 10px; background-color: #fffaf0; border-left: 3px solid #ffc107; color: #555;">
                                        {{ $task->description }}
                                    </span>
                                </p>
                            </div>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; margin-bottom: 25px;">
                            <tr>
                                <td align="center">
                                    <a href="{{ config('app.url') . '/tasks/' . $task->id }}" target="_blank" style="display: inline-block; padding: 12px 25px; font-size: 15px; color: #ffffff; background-color: #007bff; border-radius: 5px; text-decoration: none; font-weight: bold;">
                                        {{ __('ui.view') }}
                                    </a>
                                </td>
                            </tr>
